...
# Load an image from URL or file path
image_url = '/content/image 5.png'  # Replace with your image URL or file path
image = cv2.imread(image_url)
...
![OUTPUT](<translation 02.png>)
### ii) Image Scaling
![OUTPUT](scaled.png)
![OUTPUT](<scaled 02.png>)
### iii)Image shearing
![OUTPUT](sheared.png)
![OUTPUT](<sheared 02.png>)
### iv)Image Reflection
![OUTPUT](reflection.png)
![OUTPUT](<reflection 02.png>)
![OUTPUT](<reflection 03.png>)
### v)Image Rotation
![OUTPUT](rotation.png)
![OUTPUT](<rotation 02.png>)
### vi)Image Cropping
![OUTPUT](cropping.png)
![OUTPUT](<cropping 02.png>)
